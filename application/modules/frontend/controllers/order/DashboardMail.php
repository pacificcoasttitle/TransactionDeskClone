    ...
    public function sellerInfo($random_number)
    {
        ...
        if ($this->input->post()) {
            $sellerInfoData = array(
                ...
                'ssn1' => $this->input->post('ssn1') ? $this->input->post('ssn1') : null,
                'ssn2' => $this->input->post('ssn2') ? $this->input->post('ssn2') : null,
                'ssn3' => $this->input->post('ssn3') ? $this->input->post('ssn3') : null,
                ...
                'second_ssn1' => $this->input->post('second_ssn1') ? $this->input->post('second_ssn1') : null,
                'second_ssn2' => $this->input->post('second_ssn2') ? $this->input->post('second_ssn2') : null,
                'second_ssn3' => $this->input->post('second_ssn3') ? $this->input->post('second_ssn3') : null,
