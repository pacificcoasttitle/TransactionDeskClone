...
.pct-page-modern .btn-info { background: #33C3F0; border-color: #33C3F0; color: #fff; }
.pct-page-modern .btn-info:hover { background: #2CB3E0; border-color: #2CB3E0; }
.pct-page-modern .datatable-header {justify-content: unset;  }
</style>
            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">Upload Lender Document</h6>
                    </div>
                    <div class="card-body">
