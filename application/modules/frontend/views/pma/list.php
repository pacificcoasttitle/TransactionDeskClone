...
<body>
    ...
    <section class="section-type-4a section-defaulta" style="padding-bottom:0px;">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<div class="">
						<h2 class="ui-title-block ui-title-block_light">PMA</h2>
									...
									<div class="form-body">
										...
										<div class="frm-row">
											...
											<div class="section colm colm4">
												<label class="field prepend-icon">
													<input type="text" class="gui-input js-pma-city" name="city_input" value="<?php echo (!empty($prev_data['city_input'])) ? $prev_data['city_input'] : '';?>" placeholder="City">
													<span class="field-icon"><i class="fa fa-map-marker "></i></span>
												</label>
											</div>
	...
	<div class="modal fade" id="run-pma-dialog" title="Report Info" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
			  	<form id="run-pma-form" class="form-horizontal">
					...
					<div class="modal-body search-result">
				  		...
				  		<div class="custom-pma-field form-group">
				  			<label class="control-label col-sm-3" for="rep-name" >Rep:</label>
				  			<div class="col-sm-9">
				  		...
				  		<div class="custom-pma-field form-group">
						    <label class="control-label col-sm-3" for="realtor-name">Realtor Name:</label>
						    <div class="col-sm-9">
						    	<input type="text" name="realtor-name" id="realtor-name" class="text ui-widget-content ui-corner-all form-control" />
						    </div>
						</div>
						<div class="custom-pma-field form-group">
					   		<label class="control-label col-sm-3" for="realtor-company">Realtor Company:</label>
					   		<div class="col-sm-9">
					   			<input type="text" name="realtor-company" id="realtor-company" value="" class="text ui-widget-content ui-corner-all form-control" />
					   		</div>
						</div>
						<div class="custom-pma-field form-group">
						    <label class="control-label col-sm-3" for="realtor-address">Realtor Address:</label>
						    <div class="col-sm-9">
						    	<input type="text" name="realtor-address" id="realtor-address" value="" class="text ui-widget-content ui-corner-all form-control" />
						    </div>
				  		</div>
				  		<div class="custom-pma-field form-group">
				  			<label class="control-label col-sm-3" for="tabs">Include Tabs?</label>
				  			<div class="col-sm-9">
				  		...
				  		<div class="custom-pma-field form-group include-docs">
				  			<label class="control-label col-sm-3" for="docs">Include Docs?</label>
				  			<div class="col-sm-9">
				  		...
				  		<div class="custom-pma-field form-group">
				  			<label class="control-label col-sm-3" for="comps">Manually Select Comparables?</label>
				  			<div class="col-sm-9">
					...
					<div class="modal-footer">
				  		<button type="button" class="btn btn-default button blueButton pma-modal-submit">Submit</button>
					</div>
			  </form>
	  		</div>
		</div>
			...
			<div class="modal-content">
				...
				<form id="comps-form">
					...
					<div class="modal-body search-result">
			  		...
			  		<div class="modal-footer">
				  		<button type="button" class="btn btn-default comps-submit">Submit</button>
					</div>
			 	</form>
    ...
    <script src="<?php echo base_url(); ?>assets/frontend/js/pma.js"></script>
