      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        ...
        <tr>
          <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:38px;line-height:40px;font-weight:900;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">
                <div mc:edit="mczyhxraxal" style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Disbursement Completed</p></div>   
          </td>
        </tr>
		<!-- <tr>
		  ...
		  <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:18px;line-height:26px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0.5px;">
                <div mc:edit="mcrvl959r6tju" style="margin: 0px; padding: 0px;"><p style="margin-top:10px; padding:0px;"><br>Disbursement completed for order:</p>
