                                                ...
                                                <td align="center" bgcolor="#FFFFFF">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="center-text" align="center"
                                                                    ...
                                                                    <div mc:edit="mcrvl959r6t"
                                                                        ...
                                                                        <p style="margin: 0px; padding: 0px;">Good Morning </p>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td class="center-text" align="center"
                                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:500;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">

                                                                    <div mc:edit="mczyhxraxal"
                                                                        style="margin: 0px; padding: 0px;">
                                                                        <p style="margin: 0px; padding: 0px;">Please find the attached CSV file containing the completed orders report.</p>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td class="center-text" align="center"
                                                                    ...
                                                                    <div mc:edit="mcrvl959r6tju"
                                                                        style="margin: 0px; padding: 0px;">
                                                                        <p style="margin: 0px; padding: 0px;">From <?php echo date('M j, Y', strtotime($startDate));?> To <?php echo date('M j, Y', strtotime($endDate));?></p>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" bgcolor="#0387EC" style="border-radius:0px;">
                                                    <a href="<?php echo getenv('APP_URL'); ?>" mc:edit="mct3nxlesjf"
