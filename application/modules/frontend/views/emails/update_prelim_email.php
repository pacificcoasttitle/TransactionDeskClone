                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <span style="color:#000000"><strong>Prelim Update Action Required</strong></span><br>
                            ...
                            <h1 style="text-align:center;"><span style="color:#ff0000"><span style="font-size:18px"><strong><?php echo $note_subject; ?></strong></span></span></h1><br>

                            <p style="margin-top: 0px; margin-bottom: 0px; text-align:center;"><?php echo $note_text; ?></p>
