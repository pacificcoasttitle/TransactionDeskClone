...
.client {color:#f26a2a; margin-top:12px; margin-bottom:12px;font-weight:font-size;15px;}
.clienthead {color:#000000; margin-top:10px; margin-bottom:10px;font-weight:bold;font-size:18px;}
/*Outlook*/
...
.client {color:#f26a2a; margin-top:10px; margin-bottom:10px;font-weight:font-size;15px;}
.clienthead {color:#000000; margin-top:10px; margin-bottom:10px;font-weight:bold;font-size:18px;}
}
/*Responsive-Mobile*/
...
<!-- Content -->
  ...
  <tbody><tr>
    <td align="center" class="img-responsive container-padding">
      <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;" width="640" src="https://mcusercontent.com/3f123598483b787fa180fff0f/images/a58f3195-3d47-ad28-00f4-01e919bdbdcd.jpg" border="0" alt="picture">
    </td>
  </tr>
  <!-- blue-header -->
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        ...
        <tr>
          <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:48px;line-height:54px;font-weight:900;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">
                <div mc:edit="mczyhxraxal" style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">New Buying Agent Lead</p></div>   
          </td>
        </tr>
		<tr>
          <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;padding-top:10px;line-height:25px;font-weight:400;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">
                ...
                <div mc:edit="mcrvl954f9r6t" style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Below you can find information regarding this transaction,</p></div>
