...
<table data-inner-table="" border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row" width="580" style="width:580px;max-width:580px;">
  <tbody><tr>
    <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">
        <div mc:edit="mcrvl959r6t" style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Prelim Summary</p></div>
    </td>
  </tr>
  <tr>
    <td align="" bgcolor="#FFFFFF">
      <!-- content -->
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        <tbody>
            <tr>
                <td class="center-text" align="" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:36px;font-weight:400;">
                    <div mc:edit="mcrvl959r6t" style="margin: 0px; padding: 0px;">File Number: <?php echo $file_number?></div>
                    <!-- <div mc:edit="mcrvl959r6t" style="margin: 0px; padding: 0px;">Property Address: </div> -->
                </td>
            </tr>
        ...
        <tr>
            <td>
		    <p style="margin-top: 5px; padding-top: 10px;font-size: 10px;border-top: 1px solid #ccc;">
...
</table><table data-outer-table="" border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;">
  <!-- blue-cta -->
  <tbody><tr>
