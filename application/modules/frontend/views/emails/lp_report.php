                     ...
                     <tbody>
                        <tr>
                           <td align="center" class="img-responsive container-padding">
                              <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;" width="640" src="https://mcusercontent.com/3f123598483b787fa180fff0f/images/1777b9cd-34fb-317e-0bb8-c67cc8590779.jpg" border="0" alt="picture">
                           </td>
                        </tr>
                        <!-- blue-header -->
                     </tbody>
                                                ...
                                                <tr>
                                                   <td class="center-text" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:400;font-style:normal;color:#f26a2a;text-decoration:none;letter-spacing:1px;">
                                                      <div mc:edit="mcrvl959r6tju" style="margin: 0px; padding: 0px;">
                                                         <p style="margin: 0px; padding: 0px;">From  <?php echo $start_date; ?></p>
                                                ...
                                                <tr>
                                                   <td>
                                                      <table style="border-collapse: collapse; width: 100%; height: 54px;font-family:arial;" border="1">
                                                         <tbody>
                                                            <tr style="height: 18px;background-color:#f2f2f2;border-color:#c2c2c2;">
                                                               <td style="width: 100%; height: 18px; text-align: center;">Title Listing Prelims Created {<?php echo date('M', strtotime($start_date)); ?>}</td>
                                                            </tr>
                                                            <tr style="height: 18px;">
                                                               <td style="width: 40%; height: 18px; text-align: center; font-weight:bold; font-size:20px;border-color:#c2c2c2;"><?php echo $total_sum_premium;?></td>
                                                            </tr>
                                                         </tbody>
                                                      </table>
                                                      <p>&nbsp;</p>
