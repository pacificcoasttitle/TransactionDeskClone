...
<div class="pct-page-modern pct-report-page">
    <div class="container-fluid px-4 py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
            <h1 class="h3 mb-3 mb-md-0 text-gray-800" style="font-weight: 700; color: var(--pct-primary);">Farm Analysis</h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-left-0 area-input" name="area_name" value="<?php echo (!empty($prev_data['area_name'])) ? $prev_data['area_name'] : ''; ?>" placeholder="What Area?">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="sort_by" name="sort_by" class="form-control">
                                            ...
                                            <?php foreach ($sorting_fields as $key => $field_name): ?>
                ...
                <div class="card shadow">
                    <div class="card-header">
                        <h6 class="card-title">Recent Sales Activity Reports</h6>
                    </div>
                    <div class="card-body">
