    ...
    <div class="page_container">
        <div class="pdf_page size_letter">
            <div class="pdf_header">
                ...
                <img src="img/logo.png" class="pacific_logo" alt="">
            </div>
            <div class="pdf_body">
                <div class="grid">
                    <div>
                    ...
                    <div>
                        <img src="img/Price.png" alt="report">
                        <h4>Avg. Sales Price</h4>
                        <div class="count">$425,000</div>
                    </div>
                    <div>
                        <img src="img/home.png" alt="report">
                ...
                <div class="grid">
                    <div>
                        <img src="img/Bed.png" alt="report">
                        <h4>Avg. Beds</h4>
                        <div class="count">4</div>
                    </div>
                    <div>
                        <img src="img/Bath.png" alt="report">
                        <h4>Avg. Baths</h4>
                        <div class="count">3.5</div>
                    </div>
                    <div>
                        <img src="img/Rent.png" alt="report">
                        <h4>Absentee %</h4>
