...
@media only screen and (max-width:600px) and (min-width:320px) {
  ...
  .m-height25 {font-size:25px!important;line-height:30px!important;height:30px!important;}
  .radius6 {border-radius:6px!important;line-height:25px!important;height:25px!important;}
  .m-height30 {font-size:30px!important;}
                        ...
                        <div mc:edit="mcm24yhqr7x" style="margin: 0px; padding: 0px;">
                          ...
                          "
													<?php if(!empty($request_data)) : ?>
														<br>
														<h3>Check Details below:</h3>
														<table border="0">

															<?php foreach($request_data as $request_key=> $request_record): ?>
																<tr>
																	<th style="text-align: right;margin-right: 5px"><?php echo str_replace('_',' ', $request_key) ?> : </th>
																	<td><?php echo $request_record;?></td>
																</tr>
															<?php endforeach; ?>
														</table>
													<?php endif; ?>
