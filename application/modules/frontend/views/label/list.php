	...
	<div class="container-fluid padding-l-r">
		<div class="card shadow p-5">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<h5 class="text-center" ><span>Create New Label Report</span></h5>
					...
					<div class="mt-5 text-center">
						...
						<div class="table-container1">
							<table class="table table-type-3 typography-last-elem no-footer table-bordered" id="label_listing">
								<thead>
									<tr>
										<th>Date</th>
										<th>Sales Rep</th>
