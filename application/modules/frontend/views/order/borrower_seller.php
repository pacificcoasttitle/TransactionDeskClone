	...
	<section class="form_content">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p class="mb-5">
						This is an example of a Seller Welcome Package.</p>
								...
								<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
									...
									<div class="accordion-body">
										...
										<div class="form-group mb-4">
											...
											<ul class="list-inline">
												<li class="list-inline-item me-md-5">
													<input type="radio" value="yes" id="coSellerYes" name="Co-Seller" required data-error="#Co-Seller-error">
											...
											<label id="Co-Seller-error" class="error text-danger" for="Co-Seller"></label>
										</div>
										...
										<div class="coSellerInfo d-none">
											...
											<div class="form-group mb-3 row">
												...
												<ul class="list-unstyled">
													<li>
														<input type="radio" value="single" id="singlecoSeller" name="coSellermaritalStatus" data-error="#co_seller_marital_status-error">
												...
												<label id="co_seller_marital_status-error" class="error text-danger" for="coSellermaritalStatus"></label>
											</div>
									...
									<div class="accordion-body">
										...
										<div class="form-group mb-4">
											...
											<ul class="list-inline">
												...
												<li class="list-inline-item">
													<input type="radio" id="noCorrectPropertyAddress" value="other" name="is_correct_property_address">
											...
											<div class="otherAddress d-none">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group position-relative mb-3">
															<select name="state" class="form-control" id="property_state" name="property_state" data-error="#property_state-error">
										...
										<div class="form-group mb-4">
											...
											<ul class="list-inline">
												...
												<li class="list-inline-item">
													<input type="radio" id="noCorrectPropertyAddressAsCurrentAddress" value="other" name="is_property_address_as_current_address">
											...
											<div class="otherAddress d-none">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group position-relative mb-3">
															<select name="state" class="form-control" id="current_state" name="current_state" data-error="#current_state-error">
																<option value="" selected>Please Select</option>
															</select>
															<small class="small_label">State</small>
														</div>
										...
										<div class="form-group mb-4">
											...
											<ul class="list-inline">
												<li class="list-inline-item me-md-5">
													<input type="radio" id="yesForwarding" value="other" name="is_forwarding_address_different_from_current_address" required data-error="#is_forwarding_address_different_from_current_address-error">
											...
											<div class="otherAddress d-none">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group position-relative mb-3">
															<select name="state" class="form-control" id="forwarding_state" name="forwarding_state" data-error="#forwarding_state-error">
																<option value="" selected>Please Select</option>
															</select>
															<small class="small_label">State</small>
														</div>
										...
										<div class="form-group mb-4">
											...
											<ul class="list-inline">
												<li class="list-inline-item me-md-5">
													<input type="radio" id="yesinsurance" value="yes" name="insurance" required data-error="#insurance-error">
											...
											<label id="insurance-error" class="error text-danger" for="insurance"></label>
											<div class="insuranceFile d-none mb-4">
												<input type="file" name="insuranceFile" class="d-none" id="insuranceFile" data-error="#insuranceFile-error">
												<label for="insuranceFile">
													<b>Please upload your prior title insurance policy</b>
													<span>Browse Files</span>
												</label>
											</div>
											<label id="insuranceFile-error" class="error text-danger" for="insuranceFile"></label>
										</div>
									</div>
								</div>
							</div>
								...
								<div id="collapseThree" class="accordion-collapse collapse"
									...
									<div class="accordion-body">
										...
										<div class="form-group mb-4">
											...
											<ul class="list-unstyled">
												<li>
													<input type="checkbox" id="repair" value="repairs" name="payInvoice[]" required data-error="#payInvoice-error">
											...
											<label id="payInvoice-error" class="error text-danger" for="payInvoice"></label>
											<div class="insuranceFile d-none mb-4">
										...
										<ul class="list-unstyled">
											<li>
												<div class="form-group mb-3">
													...
													<ul class="list-inline">
														<li class="list-inline item me-md-5">
															<input type="radio" id="exchangeeResidenceTrue" name="is_exchange_residence" required data-error="#is_exchange_residence-error">
															<label for="exchangeeResidenceTrue">True</label>
														</li>
														<li class="list-inline item me-md-5">
															<input type="radio" id="exchangeeResidenceFalse" name="is_exchange_residence">
											...
											<li>
												<div class="form-group mb-3">
													...
													<ul class="list-inline">
														<li class="list-inline item me-md-5">
															<input type="radio" id="NotexchangeeResidenceTrue" name="is_not_exchange_residence" required data-error="#is_not_exchange_residence-error">
															<label for="NotexchangeeResidenceTrue">True</label>
														</li>
														<li class="list-inline item me-md-5">
															<input type="radio" id="NotexchangeeResidenceFalse" name="is_not_exchange_residence">
											...
											<li>
												<div class="form-group mb-3">
													...
													<ul class="list-inline">
														<li class="list-inline item me-md-5">
															<input type="radio" id="formerSpouseTrue" name="is_former_spouse" required data-error="#is_former_spouse-error">
															<label for="formerSpouseTrue">True</label>
														</li>
														<li class="list-inline item me-md-5">
															<input type="radio" id="formerSpouseFalse" name="is_former_spouse">
											...
											<li>
												<div class="form-group mb-3">
													...
													<ul class="list-inline">
														<li class="list-inline item me-md-5">
															<input type="radio" id="marriedTrue" name="is_married" required data-error="#is_married-error">
															<label for="marriedTrue">True</label>
														</li>
														<li class="list-inline item me-md-5">
															<input type="radio" id="marriedFalse" name="is_married">
											...
											<li>
												<div class="form-group mb-3">
													...
													<ul class="list-inline">
														<li class="list-inline item me-md-5">
															<input type="radio" id="periodTrue" name="is_period" required data-error="#is_period-error">
															<label for="periodTrue">True</label>
														</li>
														<li class="list-inline item me-md-5">
															<input type="radio" id="periodFalse" name="is_period">
											...
											<li>
												<div class="form-group mb-3">
													...
													<ul class="list-inline">
														<li class="list-inline item me-md-5">
															<input type="radio" id="RevenueTrue" name="is_revenue" required data-error="#is_revenue-error">
															<label for="RevenueTrue">True</label>
														</li>
														<li class="list-inline item me-md-5">
															<input type="radio" id="RevenueFalse" name="is_revenue">
															<label for="RevenueFalse">False</label>
														</li>
														<li class="list-inline item me-md-5">
															<input type="radio" id="RevenueNA" name="is_revenue">
											...
											<div class="row">
												...
												<div class="col-md-6 mb-3">
													<div class="form-group">
														...
														<ul class="list-unstyled">
															<li>
																<input type="radio" id="month" name="hoa_dues_per" data-error="#hoa_dues_per-error">
																<label for="month">Month</label>
															</li>
															<li>
																<input type="radio" id="Quarter" name="hoa_dues_per">
																<label for="Quarter">Quarter</label>
															</li>
															<li>
																<input type="radio" id="Semi-Annually" name="hoa_dues_per">
																<label for="Semi-Annually">Semi-Annually</label>
															</li>
															<li>
																<input type="radio" id="Annually" name="hoa_dues_per">
												...
												<div class="row">
													...
													<div class="col-md-6 mb-3">
														<div class="form-group">
															...
															<ul class="list-unstyled">
																<li>
																	<input type="radio" id="month" name="second_hoa_dues_per" data-error="#second_hoa_dues_per-error">
																	<label for="month">Month</label>
																</li>
																<li>
																	<input type="radio" id="Quarter" name="second_hoa_dues_per">
																	<label for="Quarter">Quarter</label>
																</li>
																<li>
																	<input type="radio" id="Semi-Annually" name="second_hoa_dues_per">
																	<label for="Semi-Annually">Semi-Annually</label>
																</li>
																<li>
																	<input type="radio" id="Annually" name="second_hoa_dues_per">
																	<label for="Annually">Annually</label>
																</li>
															</ul>
