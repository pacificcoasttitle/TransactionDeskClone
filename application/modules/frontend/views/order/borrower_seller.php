        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="">
                          <h2 class="blue_title">Seller Opening Package<br><span style="font-size:16px; padding-top:15px;">Property Address: 13321 Success Ave, Success City, CA 91253</span><br><span style="font-size:16px; padding-top:15px;">APN:000-000-0000</span></h2>
                        <div class="accordion mt-4" id="accordionExample">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">(1) Seller Information</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">(2) Property Address</button>
                                </h2>
                        ...
                        <h4 class="text-orange text-center mb-5">
                            You must click SUBMIT below to securely send your completed forms to<br> Pacific Coast Title Company.
                        </h4>
