							...
							<h3 class="ui-title-block_light">How can we help you today?</h3>
								...
								<div class="typography-sectionc">
									<div class="col-md-12">
										...
										<?php if (isset($user_email) && !empty($user_email) && (trim($user_email) == 'gladys@greenforestescrow.net' || trim($user_email) == 'docs@greenforestescrow.net' || trim($user_email) == 'patricia@greenforestescrow.net' || trim($user_email) == 'ashley@legacyfirstescrow.com')) { ?>
