<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow pct-topbar-modern">
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow mx-1 admin-notifications">
			<a class="nav-link dropdown-toggle" href="#" id="adminNotificationDropdown" role="button"
				...
				<!-- Counter - Alerts -->
				<?php if (isset($unreadNotificationCount['total_unread_count']) && $unreadNotificationCount['total_unread_count'] > 0) {?>
					<span class="badge badge-danger badge-counter" data-count="<?php echo (int) $unreadNotificationCount['total_unread_count']; ?>"><?php echo (int) $unreadNotificationCount['total_unread_count']; ?></span>
				<?php } else {?>
					<span class="badge badge-danger badge-counter d-none" data-count="0">0</span>
				<?php }?>
			</a>
			<!-- Dropdown - Alerts -->
    ...
    foreach ($notifications as $notification) {
        ...
        ?>
				...
				<a class="dropdown-item text-center small text-gray-500" href="<?php echo base_url() . 'hr/admin/notifications'; ?>">Show All Notifications</a>
			</div>
		</li>
		...
		<li class="nav-item dropdown no-arrow">
			<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
				...
				<img class="img-profile rounded-circle" src="<?php echo base_url(); ?>assets/backend/hr/img/undraw_profile.svg" alt="">
			</a>
