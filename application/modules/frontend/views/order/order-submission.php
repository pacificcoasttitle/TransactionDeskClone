<style>
/* Order Submission – same design tokens as dashboard */
.pct-home-modern {
    --pct-primary: #1e5f8a;
...
.pct-home-modern .order-card-header {
    font-size: 1rem;
    font-weight: 600;
...
.pct-home-modern .order-value {
    font-size: 1rem;
    font-weight: 600;
    color: var(--pct-text);
    margin-bottom: 1rem;
}
.pct-home-modern .order-value.highlight {
    font-size: 1.25rem;
    color: var(--pct-primary);
}

/* Tax installment cards */
.pct-home-modern .installment-card {
    background: var(--pct-surface);
    border: 1px solid var(--pct-border);
    border-radius: var(--pct-radius-sm);
    padding: 1rem;
}
.pct-home-modern .installment-card h4 {
    font-size: 0.9375rem;
    font-weight: 600;
    color: var(--pct-primary);
    margin-bottom: 0.75rem;
}
.pct-home-modern .installment-card p {
    margin: 0 0 0.5rem;
    font-size: 0.875rem;
    color: var(--pct-text);
}
.pct-home-modern .installment-card p:last-child { margin-bottom: 0; }
...
.pct-home-modern .btn-default { background: #64748b; border-color: #64748b; color: #fff; }
.pct-home-modern .btn-default:hover { background: #475569; border-color: #475569; color: #fff; }
.pct-home-modern .btn-icon-split { display: inline-flex; align-items: center; gap: 0.5rem; }

/* Action cards */
.pct-home-modern .action-card {
    background: var(--pct-surface);
    border: 1px solid var(--pct-border);
    border-radius: var(--pct-radius);
    box-shadow: var(--pct-shadow);
...
.pct-home-modern .action-card:hover {
    box-shadow: 0 4px 12px rgba(0,0,0,.1);
    transform: translateY(-2px);
}
.pct-home-modern .action-card-icon {
    width: 48px;
    height: 48px;
...
.pct-home-modern .d-flex {
    display: flex;
    align-items: center;
    justify-content: center;
}

.pct-home-modern .action-card-title {
    font-size: 1rem;
    font-weight: 600;
    color: var(--pct-text);
    margin-bottom: 0.5rem;
}
.pct-home-modern .action-card-title a { color: inherit; text-decoration: none; }
.pct-home-modern .action-card-title a:hover { color: var(--pct-primary); }
.pct-home-modern .action-card-desc {
    font-size: 0.875rem;
    color: var(--pct-text-muted);
    margin-bottom: 1rem;
    line-height: 1.5;
...
.pct-home-modern .cta-banner h3 {
    font-size: 1.25rem;
    font-weight: 600;
    margin-bottom: 0.5rem;
}
.pct-home-modern .cta-banner p {
    font-size: 0.9375rem;
    opacity: 0.9;
    margin-bottom: 1rem;
}
.pct-home-modern .cta-banner .btn { background: #fff; color: var(--pct-primary); border-color: #fff; }
.pct-home-modern .cta-banner .btn:hover { background: var(--pct-primary-soft); }

/* No data message */
.pct-home-modern .no-data-message {
    font-size: 0.875rem;
    color: var(--pct-text-muted);
    font-style: italic;
}
...
/* Processing wrapper */
.pct-home-modern .processing-wrapper {
    background: #fef3c7;
