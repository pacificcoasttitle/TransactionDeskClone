	    ...
	    if (isset($adminUsersList['data']) && !empty($adminUsersList['data'])) {
	    	foreach ($adminUsersList['data'] as $key => $value)  {
                ...
                if(isset($_POST['draw']) && !empty($_POST['draw'])) {
                    ...
                    </button><button type="button" style="cursor:pointer;" rel="tooltip" title="" onclick="deleteAdminUser('.$value["id"].')" class="btn btn-danger btn-simple btn-link" data-original-title="Remove">
