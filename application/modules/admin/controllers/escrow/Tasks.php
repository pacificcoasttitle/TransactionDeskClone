...
class Tasks extends MX_Controller {
    ...
    public function index()
    {
        ...
        $this->template->addJS( base_url('assets/backend/escrow/js/tasks.js?v=tasks_'.$this->task_js_version) );
        $this->template->show("escrow", "tasks", $data);
    }
    ...
    public function getTasks()
    {
	    ...
	    if (isset($userTypes['data']) && !empty($userTypes['data'])) {
	    	foreach ($userTypes['data'] as $key => $value)  {
                ...
                if(isset($_POST['draw']) && !empty($_POST['draw'])) {
                    $editUrl = base_url().'escrow/admin/edit-task/'.$value['id'];
    ...
    public function addTask()
    {
        ...
        $this->template->show("escrow", "add_task", $data);
    }
