...
class Order extends MX_Controller {
    ...
    function get_lp_order_list()
    {
        ...
        foreach( $ordersList['data'] as $key => $value )
        {
            ...
            $action = "<div style='display:flex;'><a href='".$editOrderUrl."' title ='View Order Detail'><i class='fas fa-eye' aria-hidden='true'></i></a><a style='margin-left:5px;' href='#' onclick='regenerateReport($file_id);' title ='Regenerate Report'><i class='fas fa-file' aria-hidden='true'></i></a><a style='margin-left:5px;' href='#' onclick='addVesting($file_id);' title ='Vesting'><i class='fas fa-institution' aria-hidden='true'></i></a><a style='margin-left:5px;' href='#' onclick='fileUpload($file_id);' title ='File Upload'><i class='fas fa-upload' aria-hidden='true'></i></a>";
