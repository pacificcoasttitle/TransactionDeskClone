...
class Home_model extends CI_Model
{
    ...
    public function get_rows($params = [], $table = '')
    {
        if (empty($table)) {
            $table = $this->table;
        }
    ...
    public function get_cpl_document_list($params)
    {
        ...
        if (isset($params['searchvalue']) && ! empty($params['searchvalue'])) {
            ...
            $this->db->select('order_details.file_number, pct_order_documents.is_sync, pct_order_documents.document_name, pct_order_documents.api_document_id, pct_order_documents.created');
            $this->db->from('order_details')
                ->join('pct_order_documents', 'order_details.id = pct_order_documents.order_id');
            $this->db->where('pct_order_documents.is_cpl_doc', 1);
            $this->db->where('order_details.is_softpro_order', 1);
    ...
    {
        $table = 'sp_company';
        $this->db->select("id, CONCAT(name, ' - ', CONCAT_WS(',', address1, city, state, zip)) AS value, name, address1, city, state, zip, lookup_code, is_escrow_company, is_lender, is_selling_agent, is_mortgage_broker, is_underwriter");
        $this->db->from($table);
        $this->db->order_by('id', 'asc');
    ...
    public function get_grant_deed_document_list($params)
    {
        ...
        if (isset($params['searchvalue']) && ! empty($params['searchvalue'])) {
            ...
            $this->db->select('order_details.lp_file_number, order_details.file_number, pct_order_documents.is_sync, pct_order_documents.document_name, pct_order_documents.api_document_id, pct_order_documents.created');
            $this->db->from('order_details')
                ->join('pct_order_documents', 'order_details.id = pct_order_documents.order_id');
            $this->db->where('pct_order_documents.is_grant_doc', 1);
            $this->db->where('order_details.is_softpro_order', 1);
    ...
    public function get_company_rows($params = [])
    {
        $table = 'pct_order_partner_company_info';
        $this->db->select('*');
        $this->db->from($table);
    ...
    public function get_lp_listing_document_list($params)
    {
        ...
        if (isset($params['searchvalue']) && ! empty($params['searchvalue'])) {
            ...
            $this->db->select('order_details.file_id, order_details.lp_report_status, order_details.lp_file_number, order_details.file_number, pct_order_documents.is_sync, pct_order_documents.document_name, pct_order_documents.api_document_id, pct_order_documents.created');
            $this->db->from('order_details')
                ->join('pct_order_documents', 'order_details.id = pct_order_documents.order_id');
            $this->db->where('pct_order_documents.is_pre_listing_report_doc', 1);
            $this->db->where('order_details.is_softpro_order', 1);
    ...
    {
        // $this->db->from('admin')
        $this->db->select('*')->from('pct_order_cron_logs');
        //          ->join('pct_admin_activity_logs', 'pct_admin_activity_logs.user_id = admin.id');
        $total_records = $this->db->count_all_results();
        ...
        if (isset($params['searchvalue']) && ! empty($params['searchvalue'])) {
            ...
            if (isset($keyword) && ! empty($keyword)) {
                $this->db->group_start()
                    ->like('api_type', $keyword)
                    ->or_like('request_type', $keyword)
                    ->or_like('request_data', $keyword)
                    ->group_end();

            }

            $this->db->select('*');
            $this->db->from('pct_order_cron_logs');
            $filter_total_records = $this->db->count_all_results();
    ...
    public function insertLpDocType($data = [], $table = '')
    {
        if (empty($table)) {
    ...
    public function insertLpAlert($data = [], $table = '')
    {
        if (empty($table)) {
            $table = 'pct_lp_alert';
        }
    ...
    public function deleteLpDocType($condition = [], $table = '')
    {
        if (empty($table)) {
            $table = 'pct_lp_document_types';
        }
    ...
    public function deleteLpAlert($condition = [], $table = '')
    {
        if (empty($table)) {
            $table = 'pct_lp_alert';
        }
    ...
    public function getLpDocType($params = [])
    {
        $this->db->select('*');
        $this->db->from('pct_lp_document_types');
    ...
    public function getMappedDocType($params = [])
    {
    ...
    public function getLpAlert($params = [])
    {
        $this->db->select('*');
        $this->db->from('pct_lp_alert');
    ...
    public function updateLpDocType($data, $condition = [], $table = '')
    {
        if (empty($table)) {
            $table = 'pct_lp_document_types';
        }
    ...
    public function updateLpAlert($data, $condition = [], $table = '')
    {
        if (empty($table)) {
            $table = 'pct_lp_alert';
        }
    ...
    public function get_customers_search($params = [], $is_master_search = 0)
    {
        $table = $this->table;
    ...
    public function sp_get_company($params = [])
    {
        $table = 'sp_company';
