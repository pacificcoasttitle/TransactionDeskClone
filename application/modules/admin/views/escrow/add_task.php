                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" name="add_task" >
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input style="width:15px;height:15px;" class="" type="radio" name="prod_type" value="prod" required>&nbsp;&nbsp;Prod&nbsp;&nbsp;
                            ...
                            <a href="<?php echo base_url().'escrow/admin/tasks'; ?>" class="btn btn-secondary btn-icon-split">
                                <span class="icon text-white-50">
