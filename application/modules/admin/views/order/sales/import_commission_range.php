...
<div class="container">
    ...
    <div class="card mx-auto mt-5">
      <div class="card-header">Import Commission Range</div>
        <div class="card-body">        
			...
			<div class="form-group row">
				<label for="commission_range_file" class="col-sm-4 col-form-label">Import File <span class="required"> *</span> <a style="font-size: 1rem;" href="<?php echo site_url('order/admin/template-commission-range'); ?>">View Template </a></label>
				<div class="col-sm-8">
