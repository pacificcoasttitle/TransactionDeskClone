...
.accordion .threshold__amounts .card,.accordion .show_hide_threshold_main_div.card{
					...
					<div class="card mx-auto mt-5 mb-5" style="border-bottom: 1px solid rgba(0, 0, 0, 0.125);">
						...
						<div id="commissionInfo" class="collapse" role="tabpanel" aria-labelledby="commissionTab" data-parent="#accordionEx">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										foreach($underwriter_types as $underwriter_type_key=>$underwriter_type):
											...
											$underwrter_id = '';
											$threshold_arr = array();
											if(isset($existing_underwriter[$product_type][$underwriter_type_key])) {
												$check_obj = $existing_underwriter[$product_type][$underwriter_type_key];
												if(!empty($check_obj->underwriter_tier_id)) {
													$default_selected = 'global';
													$underwrter_id = $check_obj->underwriter_tier_id;
												}
												elseif(!empty($check_obj->fix_commission) && (float)$check_obj->fix_commission > 0) {
											...
											<div class="card-body underwriters-div">
													...
													<div class="col-sm-8">
														<select name="commission[<?php echo $product_type;?>][<?php echo $underwriter_type_key;?>][type]"  class="selectpicker show_hide_commissiontypes_select"  data-actions-box="true">
															...
															<?php foreach($commission_types as $commission_type) {?>
																<option <?php echo set_select('commission['.$product_type.']['.$underwriter_type_key.'][type]', $commission_type,($default_selected== $commission_type) );?>  value="<?php echo $commission_type;?>"><?php echo ucwords($commission_type);?></option>
															<?php }?>
														</select>
													</div>
												</div>
														...
														<div class="col-sm-8">
															<select name="commission[<?php echo $product_type;?>][<?php echo $underwriter_type_key;?>][tire]"  class="selectpicker"  data-actions-box="true">
																...
																<?php foreach($underwriter_tires[$underwriter_type_key] as $underwriter_tire) {?>
																	<option <?php echo set_select('commission['.$product_type.']['.$underwriter_type_key.'][tire]', $underwriter_tire->id,($underwrter_id == $underwriter_tire->id) );?>  value="<?php echo $underwriter_tire->id;?>"><?php echo ucwords($underwriter_tire->title);?></option>
																<?php }?>
															</select>
														</div>
													</div>
														...
														<div class='clone-this-threshold card clone-main-div' >
															...
															?>
																...
																<div class="form-group row show_hide_threshold">
																	...
																	<div class="col-sm-4">
																		<input  step="01" min="0"  type="number" class="form-control" name="commission[<?php echo $product_type;?>][<?php echo $underwriter_type_key;?>][threshold_amount_min][]"  class="form-control" placeholder="Minimum Amount" value="<?php echo $min_range_val;?>">
																	</div>
																	<div class="col-sm-4">
																		<input  step="01" min="0"  type="number" class="form-control" name="commission[<?php echo $product_type;?>][<?php echo $underwriter_type_key;?>][threshold_amount_max][]"  class="form-control" placeholder="Maximum Amount" value="<?php echo $max_range_val;?>">
																	</div>
																</div>
																<div class="form-group row show_hide_threshold">
																	<label  class="col-sm-4 col-form-label">Commission %</label>
																	<div class="col-sm-8">
																		<input  step="0.1" min="0"  type="number" class="form-control" name="commission[<?php echo $product_type;?>][<?php echo $underwriter_type_key;?>][threshold_commission][]"  class="form-control" placeholder="Threshold commision %" value="<?php echo $threshold_commission;?>">
																	</div>
																</div>
												...
												<div class="show_hide_commissiontypes show_hide_commissiontypes-fix">
													<div class="form-group row">
														<label  class="col-sm-4 col-form-label"> Commission %</label>
														<div class="col-sm-8">
															<input  step="0.1" min="0"  type="number" class="form-control" name="commission[<?php echo $product_type;?>][<?php echo $underwriter_type_key;?>][fix_commission]"  class="form-control" placeholder="Threshold commision %" value="<?php echo set_value('commission['.$product_type.']['.$underwriter_type_key.'][fix_commission]',$fix_commission) ?>">
														</div>
													</div>
												</div>
											</div>
							...
							/*
								...
								?>
								<div class="show_hide_threshold_main_div card">
									<div class="card-body">
										<div class="form-group row">
										...
										<div class='threshold__amounts show_hide_threshold'>
											...
											$max_range_val = "";
											$commission_val = "";
											if($check_underwriter_val && count($check_underwriter_val->underwriter_user_threshold_obj) && isset($check_underwriter_val->underwriter_user_threshold_obj[0])) {
												$min_range_val = $check_underwriter_val->underwriter_user_threshold_obj[0]->threshold_amount_min;
												$max_range_val = $check_underwriter_val->underwriter_user_threshold_obj[0]->threshold_amount_max;
												$commission_val = $check_underwriter_val->underwriter_user_threshold_obj[0]->threshold_commission;
												unset($check_underwriter_val->underwriter_user_threshold_obj[0]);
											}
											?>
											<div class='clone-this-threshold card clone-main-div' >
												<div class="card-body">
													<div class = "form-group row">
														<div class="col-sm-12">
															<div class="remove-btn-holder"><button type="button" class="btn btn-danger threshold-remove-btn"><i class="fa fa-times"></i></button></div>
														</div>
													</div>
													<div class="form-group row show_hide_threshold">
														<label  class="col-sm-4 col-form-label">Threshold Amount Range</label>
														<div class="col-sm-4">
															<input  step="01" min="0"  type="number" class="form-control" name="underwrter[<?php echo $key;?>][threshold_amount_min][]"  class="form-control" placeholder="Minimum Amount" value="<?php echo $min_range_val ?>">
														</div>
														<div class="col-sm-4">
															<input  step="01" min="0"  type="number" class="form-control" name="underwrter[<?php echo $key;?>][threshold_amount_max][]"  class="form-control" placeholder="Maximum Amount" value="<?php echo $max_range_val ?>">
														</div>
													</div>
													<div class="form-group row show_hide_threshold">
														<label  class="col-sm-4 col-form-label">Commission %</label>
														<div class="col-sm-8">
															<input  step="0.1" min="0"  type="number" class="form-control" name="underwrter[<?php echo $key;?>][threshold_commission][]"  class="form-control" placeholder="Threshold commision %" value="<?php echo $commission_val ?>">
														</div>
													</div>
											...
											<div class='clone-to-threshold'>
												<?php
												foreach($check_underwriter_val->underwriter_user_threshold_obj as $underwriter_user_threshold_obj): 
													$min_range_val = "";
													$max_range_val = "";
													$commission_val = "";
													if(count($underwriter_user_threshold_obj)) {
														$min_range_val = $underwriter_user_threshold_obj->threshold_amount_min;
														$max_range_val = $underwriter_user_threshold_obj->threshold_amount_max;
														$commission_val = $underwriter_user_threshold_obj->threshold_commission;
													}
												?>
													<div class='clone-this-threshold card' >
														<div class="card-body">
