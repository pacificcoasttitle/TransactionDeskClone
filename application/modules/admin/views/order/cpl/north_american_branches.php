<div class="pct-admin-listing">
    ...
    <div class="page-header">
        ...
        <div class="action-buttons">
            <a href="javascript:void(0);" id="refresh_north_american_branches" class="btn-action btn-action-success">
    ...
    <div class="modern-card">
        ...
        <div class="modern-card-body">
            <div id="north_american_success_msg" class="alert-modern alert-success-modern" style="display:none;"></div>
            <div id="north_american_error_msg" class="alert-modern alert-danger-modern" style="display:none;"></div>
