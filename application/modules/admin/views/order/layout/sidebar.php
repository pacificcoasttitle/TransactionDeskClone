...
<ul class="sidebar navbar-nav">
	...
	<li class="nav-item dropdown">
		...
		<div class="dropdown-menu" aria-labelledby="documentDropDown" id="documents">
			...
			<a class="dropdown-item <?php if($this->uri->uri_string() == 'order/admin/pre-listing-documents') { echo 'active'; } ?>" href="<?php echo base_url().'order/admin/lp-listing-documents'; ?>">LP Listing</a>
        </div>
	</li>
