<div class="pct-admin-listing">
    ...
    <div class="page-header">
        <h1><i class="fas fa-edit"></i> Edit Daily Email Receiver</h1>
    ...
    <!-- Edit Daily Email Receiver Form Card -->
    <div class="modern-card">
        <div class="modern-card-header">
            <h2><i class="fas fa-envelope"></i> Edit Daily Email Receiver</h2>
        </div>
        <div class="modern-card-body">
            ...
            <form id="frm-add-holiday" method="POST">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" value="<?php echo $receiver_info['email']; ?>" class="form-control" name="email" id="email" placeholder="Email">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="row">
                            ...
                            <input type="checkbox" class="col-sm-3 form-control" name="status" id="status" <?php echo ($receiver_info['status']) ? "checked" : ""; ?>>
                        </div>
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <button type="submit" id="addFee" name="addHoliday" class="btn-action btn-action-primary">
