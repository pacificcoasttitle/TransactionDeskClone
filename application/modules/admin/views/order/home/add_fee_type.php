<div class="pct-admin-listing">
    ...
    <div class="page-header">
        <h1><i class="fas fa-plus-circle"></i> Fee Type</h1>
    ...
    <!-- Add Fee Type Form Card -->
    <div class="modern-card">
        <div class="modern-card-header">
            <h2><i class="fas fa-tag"></i> Add Fee Type</h2>
        </div>
        <div class="modern-card-body">
            ...
            <form id="frm-add-fee-type" method="POST">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="fee_type" id="fee_type" placeholder="Fee Type">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <button type="submit" id="addFeeType" name="addFeeType" class="btn-action btn-action-primary">
