      ...
      <div class="card-header">Edit LP Document type</div>
        <div class="card-body">        
            <form id="frm-edit-document-type" method="POST">
                ...
                ?>
                <div class="form-group row selectsubtype <?php echo isset($lp_document_info['subtype_flag']) && !empty($lp_document_info['subtype_flag']) ? 'hide' : '' ?> ">
                ...
                <div class="pull-right">
                    ...
                    <a href="<?php echo site_url('order/admin/lp-document-types'); ?>" id="cancel" name="cancel" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
