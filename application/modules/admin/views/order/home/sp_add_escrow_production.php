<div class="pct-admin-listing">
    ...
    <div class="page-header">
        <h1><i class="fas fa-plus-circle"></i> Escrow Production</h1>
        <div class="action-buttons">
            <a href="<?php echo site_url('order/admin/escrow-production'); ?>" class="btn-action btn-action-secondary">
                <i class="fas fa-arrow-left"></i> Back
            </a>
        </div>
    </div>

    <!-- Add Escrow Production Form Card -->
    <div class="modern-card">
        <div class="modern-card-header">
            <h2><i class="fas fa-file-contract"></i> Add Escrow Production</h2>
        </div>
        <div class="modern-card-body">
            ...
            <form id="frm-add-escrow-production" method="POST">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <button type="submit" id="add-escrow-production" name="add-escrow-production" class="btn-action btn-action-primary">
