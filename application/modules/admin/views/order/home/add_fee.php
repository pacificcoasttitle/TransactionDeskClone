<div class="pct-admin-listing">
    ...
    <div class="page-header">
        <h1><i class="fas fa-plus-circle"></i> Add Fee</h1>
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <h2><i class="fas fa-dollar-sign"></i> Add Fee</h2>
        </div>
...
?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="fee_name" id="fee_name" placeholder="Fee Name">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="fee_value" id="fee_value" placeholder="Fee Value">
