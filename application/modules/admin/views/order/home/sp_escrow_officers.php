...
<div class="container-fluid">
    <div class="row mb-3">
		<div class="col-sm-6">
			<h1 class="h3 text-gray-800">Softpro Escrow Officers </h1>
		</div>
		<div class="col-sm-6">
            <a href="javascript:void" onclick="syncSoftProEscrowOfficer();"  class="btn btn-success btn-icon-split float-right mr-2"> 
