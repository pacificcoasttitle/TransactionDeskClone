                    ...
                    <div class="card-body">
                        <form id="frm-edit-title-production" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="telephone" id="telephone" class="form-control" placeholder="Phone Number" value="<?php echo isset($title_production_info['telephone_no']) && !empty($title_production_info['telephone_no']) ? $title_production_info['telephone_no'] : '' ?>">
