        ...
        <?php if ($branchName == 'TSG') {?>
            <table class="salesrep-table">
                <thead>
                    ...
                    <tr>
                        <th colspan="3">Trustee Sale Guarantee</th>
                        <th colspan="3">Trustee Sale Guarantee</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="number"><?php echo $salesDetails['today_tsg_cnt']; ?></td>
                        <td class="number"><?php echo $salesDetails['mtd_tsg_cnt']; ?></td>
                        <td class="number"><?php echo $salesDetails['prior_tsg_cnt']; ?></td>
                        
                        <td class="currency">$<?php echo number_format(round($salesDetails['today_tsg_rev'])); ?></td>
                        <td class="currency">$<?php echo number_format(round($salesDetails['mtd_tsg_rev'])); ?></td>
                        <td class="currency">$<?php echo number_format(round($salesDetails['prior_tsg_rev'])); ?></td>
                        
                        <?php
                            
                            $totalTodayTSGCnt += $salesDetails['today_tsg_cnt'];
                            $totalMtdTSGCnt += $salesDetails['mtd_tsg_cnt'];
                            $totalPriorTSGCnt += $salesDetails['prior_tsg_cnt'];

                            $totalTodayTSGRev += $salesDetails['today_tsg_rev'];
                            $totalMtdTSGRev += $salesDetails['mtd_tsg_rev'];
                            $totalPriorTSGRev += $salesDetails['prior_tsg_rev'];
                    ...
                    <tr>
                        ...
                        <td class="number"><strong><?php echo $totalTodayTSGCnt; ?></strong></td>
                        <td class="number"><strong><?php echo $totalMtdTSGCnt; ?></strong></td>
                        <td class="number"><strong><?php echo $totalPriorTSGCnt; ?></strong></td>
                        
                        <td class="currency"><strong>$<?php echo number_format(round($totalTodayTSGRev)); ?></strong></td>
                        <td class="currency"><strong>$<?php echo number_format(round($totalMtdTSGRev)); ?></strong></td>
                        <td class="currency"><strong>$<?php echo number_format(round($totalPriorTSGRev)); ?></strong></td>
