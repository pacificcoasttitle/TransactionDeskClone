...
.pct-report-container .title-table { border-collapse: separate; border-spacing: 0; width: 100%; margin: 0 0 24px 0; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
.pct-report-container .title-table th { background: linear-gradient(135deg, #f8f9fc 0%, #e9ecef 100%); border: none; border-bottom: 2px solid #dee2e6; padding: 14px 12px; text-align: center; font-weight: 700; color: var(--report-primary); font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; }
.pct-report-container .title-table td { border: none; border-bottom: 1px solid #eef0f5; padding: 12px 10px; text-align: center; background-color: #ffffff; font-size: 13px; transition: all 0.2s ease; }
.pct-report-container .title-table tr:nth-child(even) td { background-color: #f8f9fc; }
.pct-report-container .title-table tr:hover td { background-color: #e8f4fd !important; }

.pct-report-container .title-officer-name { text-align: left !important; font-weight: 600; color: var(--report-primary); padding-left: 16px !important; }
...
<div class="pct-admin-listing pct-report-container">
    ...
    <div class="modern-card">
        <div class="report-header-banner">
            <h2><i class="fas fa-file-alt"></i> Title Officer Performance</h2>
