					...
					<div class="smart-forms smart-container">
						<form method="POST" id="smart-form" enctype="multipart/form-data" >
							<div class="form-body">
								...
								<div class="frm-row">
									<div class="row">
										<div class="section colm colm6 col-md-9">
											<label class="field prepend-icon file">
												<span class="button"> Choose File </span>
												<input type="file" class="gui-file form-control" name="file" id="csvFile"
												onChange="document.getElementById('uploader1').value = this.value;" accept=".xlsx, .xls">
