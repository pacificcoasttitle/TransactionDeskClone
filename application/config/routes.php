...
$route['get-notes/:num'] = 'frontend/order/titleOfficers/get_notes';
$route['create-note'] = 'frontend/order/titleOfficers/create_note';
...
$route['sales-production-history'] = 'frontend/order/salesRep/salesProductionHistory';
$route['title-officer-production-history'] = 'frontend/order/titleOfficers/titleOfficerProductionHistory';
