...
$route['order-submit/:any']                   = 'frontend/order/home/orderSubmit';
...
$route['get-fees/:num']                       = 'frontend/order/dashboard/get_softpro_fees';
...
$route['title-officer-production-history/:any'] = 'frontend/order/titleOfficers/productionHistory';
...
$route['home/getDetailsFromLookup']             = 'frontend/order/common/getDetailsFromLookup';
...
$route['getDetailsFromLookup']                  = 'frontend/order/common/getDetailsFromLookup';
...
$route['get-contacts']                          = 'frontend/order/common/get_contacts';
$route['get-fees-invoice']                      = 'frontend/order/common/get_fees_invoice';
...
$route['ranking']                                = 'frontend/order/salesRep/salesRanking';
$route['get-sales-ranking']                      = 'frontend/order/salesRep/getSalesRanking';

/** Escrow Dashboard Routes */
...
$route['order/admin/send-order-to-softpro']      = 'admin/order/home/sendOrderToSoftpro';
...
$route['order/admin/recording-email-logs']       = 'admin/order/home/recordingEmailLogs';
