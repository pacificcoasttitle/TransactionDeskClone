...
<section class="content-wrapper">
      ...
      <form id="get_quote" action="<?=base_url()?>index.php?welcome/receipt" method="POST" role="form" >
         <div class="row mil">
            ...
            <div class="column four">
               <select name="county" class="sarinput" onchange="countryOnChnage(this.value);" id="select_county" style="display:none">
                  <option value="" class="city_null">Select County</option>
                  <?php foreach ($county_list as $county): ?>
                    <option value="<?=$county->zone_name?>__<?=$county->transaction_type?>" class="region<?php $ss = str_replace(' ','_',$county->region); echo $ss;?>"><?=$county->zone_name?></option>
                  <?php endforeach ?>
               </select>
            </div>
            <?php/*<div class="column four">
   ...
   <p>&nbsp;</p> 
   <div class="row ">
      <h2 class="ui-title-block-3 ui-title-block-3_sm" style="color:#888; margin-top: 15px;">Transaction Details</h2>
      <hr class="w"/>
      <div class="column four first">
