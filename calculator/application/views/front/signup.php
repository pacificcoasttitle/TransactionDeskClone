                ...
                <div class="row signup-form">
                   <form action =''  method="post" onsubmit="return validate()" >
                    ...
                    <div class="column twelve">
                        <input type="email" placeholder="Email Id" class=""  onblur="check_email()" id="email" name="email" required>
                    </div>
                    ...
                    <div class="column">
                        <button class="button orange small submit" type="submit" id="submit_btn">Sign Up</button>&nbsp;|&nbsp;
                        <button class="button grey small"  style="border:none;" id="open-signin-form">Already Registered</button>
                    </div>
                    </form>
                </div>
                <div class="row signin-form">
                  <form action ='' id="login_form" method="post" onsubmit ="return do_login()" >
                    ...
                    <div class="column twelve">
                        ...
                        <button type="button" class="button grey small" id="forget-pass" style="border:none;">Forget Password</button>
                        <hr style="border-color:#a1a1a1;">
                        <button class="button blue small"  style="border:none;" id="open-signup-form">Sign Up For Access</button>
                    </div>
                    </form>
                </div>
                <div class="row forget-form">
                  <form action ='' id="forget_login" method="post" onsubmit ="return reset_password()" >
                    ...
                    <div class="column five">
                        <a type="button" placeholder="send reset" id="forget_btn" class="button orange small">Get Reset Code</a>
                    </div>
                    <div class="column twelve">
...
$.ajax({
url     : "<?=base_url()?>index.php?welcome/check_availability_email",
type    : "post",
data    :{email:email_id},
 ...
 function do_login()
    {
        ...
        $.ajax({
            ...
            success : function( data )
            {
                ...
                {
                    $("#output_body").html("Your Email id is verified. But Your Profile is not Activated By Admin panel.");
                    $("#output").show();
                    $("#loading1").hide();
                }
            },
...
function reset_password () 
{
   var new1 = $("#password1").val();
    ...
    $("#output").hide();
    $.post( 
             "<?=base_url()?>index.php?welcome/reset_password",
             $("#forget_login").serialize(),
               function(data)
              {
