                    ...
                    <tbody>
                        <?php
                          ...
                          <tr>
                              ...
                              <td>
                                <form action="<?php echo base_url(); ?>index.php/welcome/admin_dashboard_submit" method="post" accept-charset="utf-8" id="user_role_<?php echo $user->user_id_pk; ?>">
                                 ...
                                 <div class="modal" id="reset-modal<?php echo $user->user_id_pk; ?>">
                                    <div class="modal-dialog">
                                       <div class="modal-content">
                                          <form action="<?php echo base_url(); ?>index.php?welcome/reset_user_pass/<?php echo $user->user_id_pk; ?>" method="POST" role="form">
...
<script>
   function form_submit (form_id) {
     ...
     $.ajax({
      url     : "<?php echo base_url(); ?>index.php?welcome/admin_dashboard_submit",
      type    : "POST",
      data    : form_data,
      success : function( data )
      {
          ...
          {
            window.location.assign('<?php echo base_url(); ?>index.php?welcome/admin_login');
          }
      },
