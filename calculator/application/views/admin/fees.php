    ...
    <div class="card mb-3">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="<?php echo base_url(); ?>index.php?admin/add_fees" class="btn btn-secondary"> Add Fees </a>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr id="fees_<?php echo $row['id'];?>">
                               ...
                               <td>
                                   <a href="<?php echo base_url(); ?>index.php?admin/edit_fees/<?php echo $row['id']; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script type="text/javascript">
    ...
    {
        $.ajax({
          url     : "<?php echo base_url(); ?>index.php?admin/delete_fees",
          type    : "POST",
          data    : {id:id},
