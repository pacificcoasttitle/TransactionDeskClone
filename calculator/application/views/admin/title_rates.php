    ...
    <div class="card mb-3">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="<?php echo base_url(); ?>index.php?admin/import_title_rates" class="btn btn-secondary"> Import </a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                               ...
                               <td>
                                <a href="<?php echo base_url(); ?>index.php?admin/edit_title_rates/<?php echo $row['title_rate_id_pk']; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script type="text/javascript">
    ...
    {
        $.ajax({
          url     : "<?php echo base_url(); ?>index.php?admin/delete_title_rates",
          type    : "POST",
          data    : {id:id},
