...
class Associate_model extends CI_Model 
{
	...
	public function get_user_count()
	{
	  ...
	  $this->db->where('direct_id', $this->session->userdata('asso_ref_id'));
	  $query=$this->db->get('mlm_users');
	...
	{
		$this->db->where('store_id', $this->session->userdata('asso_id'));
...
{
	$this->db->where('user_id', $this->session->userdata('asso_id'));
	$query = $this->db->get('monthly_revenue');
...
public function get_credit_limit()
{
	...
	$this->db->where('id', $this->session->userdata('asso_id'));
	$query = $this->db->get('mlm_users');
	return $query->row();
}
