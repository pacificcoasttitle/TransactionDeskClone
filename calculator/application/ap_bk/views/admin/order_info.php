                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                                     ...
                                     <form action="" class="form col-lg-6 col-md-offset-3" method="POST" role="form" enctype="multipart/form-data">
                                       <legend>View Order </legend>
                                        ...
                                        <table class="table">
                                          ...
                                          <tbody>
                                            <tr><td><label for="">Speciality</label> </td><td><?=$order_info->speciality?></td></tr>
                                          <tr><td><label for="">Journal</label> </td><td><?=$order_info->journal?></td></tr>
                                          <tr><td><label for="">Journal Link</label> </td><td><?=$order_info->journal_link?></td></tr>
                                          <tr><td><label for="">Document Title</label> </td><td><?=$order_info->document_title?></td></tr>
                                          <tr><td><label for="">Format Figure</label> </td><td><?=$order_info->format_fugure?></td></tr>
                                          <tr><td><label for="">Format Document</label> </td><td><?=$order_info->format_document?></td></tr>
                                          <tr><td><label for="">Figure Count</label> </td><td><?=$order_info->figure_count?></td></tr>
                                          <tr><td><label for="">Special Request</label> </td><td><?=$order_info->special_request?></p></td></tr>
                                          <tr><td><label for="">Order Amount</label> </td><td><?=$order_info->payment?></p></td></tr>
                                          <tr><td><label for="">Payment Status</label> </td><td><?=$order_info->payment_status?></p></td></tr>
                                          <tr><td><label for="">Transaction ID</label> </td><td><?=$order_info->transaction_id?></p></td></tr>
                         ...
                         $dirname = "upload/manuscript_development/".$order_info->order_for."/".$order_info->order_id;
                         $stru = base_url()."upload/manuscript_development/".$order_info->order_for."/".$order_info->order_id;
        ...
        ?>
         <div class="col-lg-4">
                <?=$thumb?>
                                ...
                                <?=$file;?>
                                <p><a class="btn btn-success" href="<?=base_url()?>admin/download_file/<?=$order_info->order_id?>?file=<?=$file?>&order_for=<?=$order_info->order_for?>" >Download</a> </p>
