 ...
 ?>
             ...
             <?php include 'ext-menu.php';?>
							...
							<ol class="breadcrumb">
								...
								<li class="active">Become A Reviewer</li>
							</ol>
              ...
              <div class="col-xs-6 col-sm-6">
                    ...
                    Referee Presubmission Manuscripts. Become a Reviewer
                    </b></h3>
                  <!--  <h4>Opportunities for Presubmission Independent Peer Review </h4> -->
                    <p>Presubmission peer review can help enhance both the quality of scholarly work and the collegiality of the research environment. To facilitate a non-adversarial independent peer review process, MyReposit calls upon actively practicing credentialed experts to Referee presubmission manuscripts and help authors publish faster.</p>
                

                            <div class="col-cont">
                                <div class="col-head">
                                    <h5 class="col-title"><a  data-toggle="collapse" href="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                       <i style="display:none;" class=" icon-plus"></i> <i  class="icon-minus"></i>Reviewer requirements
                                    </a></h5>
                                </div>
                                <div class="col-body collapse in" id="collapse2">
                                    <ul class="listing">
                      <li> Terminal degree (PhD, MD or MD-PhD, DVM, DDS, DMD, or other doctoral level degree) in an area of research mandatory</li><br>
<li>Reviewer must be of a level of full, assistant or associate professor. Postdoctoral fellow, faculty research associates/instructor may apply.  Prior experience as a journal peer reviewer necessary.</li><br>
<li>Reviewer must have first author or corresponding author credentials in peer reviewed academic journals.</li>
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <a class="btn btn-primary btn-block" style="margin-top: 20px" href="#"><b>Apply with MyReposit Account</b></a>
                      <p>&nbsp;</p>
                    <form class="" action="<?=base_url()?>index.php/welcome/become_reviewer_apply" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="inputPassword3" required pattern="^[ .a-zA-Z]+$" placeholder="Designation" data-placement="right" title="Designation"value="<?=$user_info->designation?>" name="designation">
                            </div>
                            <div class="form-group">
...
<li>Reviewer must have first author or corresponding author credentials in peer reviewed academic journals.</li>
									...
									<div class="col-xs-12 col-sm-6">
										<a class="btn btn-primary btn-block" style="margin-top: 20px" href="<?=base_url()?>become_reviewer_apply"><b>Apply with MyReposit Account</b></a>
											
                        
                     
                      <p style="text-align:center">
											<b><!-- <a href="<?=base_url()?>login">Login</a> With Myreposit Account.-->
											OR <br>
											Complete the form below</b></p>
											<!-- <li>Do not have account? <a href="<?=base_url()?>signup">Create one</a></li>
											 -->
									
										<form action ='' class="" method="post" onsubmit="return validate()" enctype="multipart/form-data">
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="college" id="input" class="form-control" required="required">
    </div>
    <div class="form-group">
      <label class="control-label"> Website, Blog or Portfolio</label>
      <input type="text" name="blog_url" id="input" class="form-control" >
    </div>
    <div class="form-group">
...
<div class="form-group">
    ...
    <div class=" ">
     <div class="checkbox">
         <label>
             <input type="checkbox" value="" required>
            <small style="line-height:8px;"> This is to confirm that I have read, understood and agree to all the <a data-toggle="modal" href='#modal-id'> Terms of Service</a> mentioned in MyReposit.com. I also confirm that I am entering into this agreement voluntarily, with full knowledge of its effect.</small>
         </label>
     </div>
