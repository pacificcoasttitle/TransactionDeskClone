              ...
              <div class="panel-body">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-10">
                    <H3 class="no-margin margin-bottom-10">Formatting </H3>
                  
                    <p>Our service concentrates on improve the flow of your manuscript to make it more effective. Our editors will
polishes the written style and check for errors in spelling, grammar, punctuation, sentence construction,
syntax, paragraph transitions and flow of your manuscript. We are committed to helping researchers increase
their chances of publication by submitting manuscripts that are free of language errors.</p>
</div>
                </div>
                <div class="clearfix">
                  <p></p>
                ...
                <div class="row  table-function" id="third1">
                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="panel panel-info">
                      ...
                      <div class="panel-body">
                        <ul>
                          <li>Journal guidelines compatibility check (e.g. line spacing, font, and heading style etc.)</li>
                          <li>Manuscript proofread for errors</li>
                        </ul>
                      </div>
                      <div class="panel-footer">
                        <?php if ($type=='std'): ?>
                        <a onclick="selected(this,'std')" class="btn-round btn-success btn-alt btn-block std selected1"> Standard Formatting</a>
                          
                        <?php else: ?>
                        <a  onclick="selected(this,'std')" class="btn btn-round std btn-success btn-alt btn-block">Select Standard Formatting</a>
                    ...
                    <div class="panel panel-pup">
                      ...
                      <div class="panel-body">
                        <ul>
                          <li>Journal guidelines compatibility check (e.g. line spacing, font, and heading style etc.)</li>
                          <li>Manuscript proofread for errors </li>
                          <li>Reference formatting to Journal requirement</li>
                        </ul>
                      </div>
                      <div class="panel-footer">
                       <?php if ($type=='pro'): ?>
                        <a  onclick="selected(this,'pro')" class="btn-round btn-success btn-alt btn-block selected2"> Pro Formatting</a>
                          <?php else: ?>
                        <a  onclick="selected(this,'pro')"  class="btn btn-round btn-success btn-alt btn-block">Select Pro Formatting</a>
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="panel panel-danger">
                      ...
                      <div class="panel-body">
                        <ul>
                          <li>Publication ready complete Manuscript Formatting</li>
                          
                        </ul>
                      </div>
                      <div class="panel-footer">
                      <?php if ($type=='pro_plus'): ?>
                        <a  onclick="selected(this,'pro_plus')" class=" btn-round btn-success btn-alt btn-block selected3"> Pro+ Formatting</a>
                        
                      <?php else: ?>
                        <a  onclick="selected(this,'pro_plus')" class="btn btn-round btn-success btn-alt btn-block">Select Pro+ Formatting</a>
