					...
					<div class="content-wrapper">
						<section id="content">
							...
							<ol class="breadcrumb">
								...
								<li class="active">All  Portfolio</li>
							</ol>
										...
										<div class="my-account-sidebar">
											...
											<div class="sidebar-nav">
											    <ul class="cat-nav1">
													...
													<li>
														<a href="<?=base_url()?>speciality/<?=$name?>"><i><img src="<?=base_url()?>assets/front/images/icon/<?=$key->departmentname?>.jpg"></i> <?=$key->departmentname?></a>
										...
										<div class="panel panel-default flat">
											<div class="panel-body">
												...
												<div class="row">
													...
													<h3 class="panel-title" style=" padding-bottom: 5px; border-bottom: 1px solid rgb(204, 204, 204);">All  Portfolio</h3>
													<p></p>
													<div >
														<!-- start doctor list -->
													...
													<li>
																<div class="row ">
																	...
																	<div class="col-xs-8 col-sm-10 col-md-7 col-lg-7 ">
																		<p ><b><a href="<?=base_url()?>user-articles/<?=$key->slug?>"><?=ucfirst($key->salutation." ".ucfirst($key->fname)." ".ucfirst($key->lname));?></a></b><br>
																		<?=$key->designation?><br>
