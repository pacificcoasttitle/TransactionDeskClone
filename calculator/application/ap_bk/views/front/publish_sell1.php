    ...
    <section id="content">
      ...
      <div class="panel panel-default flat">
        <div class="panel-body">
         ...
         <p class="">Get one-on-one formatting, layout, cover and interior design support on your Hardcover, Paperback or eBook.</p>
               ...
               <form class="login-form pub-form" action="<?=base_url()?>index.php/welcome/publish_sell_submit_request/" method="post" enctype="multipart/form-data">
                <div class=" panel-primary">
                 ...
                 <div class="form-group">
                  ...
                  <a class="btn-link pull-right" href="<?=base_url()?>edit-profile" role="button">Edit Information</a>
                  <div class="form-group">
          ...
          <div class="clearfix">
            ...
            <form class="login-form pub-form" action="<?=base_url()?>index.php/welcome/publish_sell_submit/" method="post" enctype="multipart/form-data">
              ...
              <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                <div class=" panel-primary">
                  <div class="panel-heading">
                    <h4 class="panel-title">STEP 2: DESCRIBE YOUR PRODUCT </h4>
                  </div>
                  
                  
                  <div class="form-group">
                    <label>Your Product Information Here</label>
                    <input type="text" name="product_name" id="input" class="form-control" value="" required="required"  title=""  placeholder=" Title of product ">
                  </div>
                  <div class="form-group">
                    <textarea name="desc" id="input" class="form-control" rows="3" placeholder="Short description of product" required="required"></textarea>
                    
                  </div>
                  <div class="form-group">
                    <input type="text" name="price" id="input" class="form-control" value="" required="required"  title=""  placeholder="Set cost of product  ">
                  </div>
                 ...
                 <div class="row"  id="payment_paypal" style="display:none;">
                    <div class="form-group">
                    <label><b>Paypal email  </b></label>
                    <input type="text" name="paypal_id" id="input" class="form-control" value="" required="required"  title=""  placeholder="Paypal email">
                  </div>
                 </div>
              ...
              <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                <div class=" panel-primary">
                  <div class="panel-heading">
                    <h4 class="panel-title">STEP 3: UPLOAD YOUR PRODUCT  </h4>
                  </div>
            ...
            <div class="checkbox">
              <label>
               ...
               I have full rights to distribute and sell the files I have uploaded.
              </label>
