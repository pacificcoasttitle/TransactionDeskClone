              ...
              <div class="panel-body">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-10">
                    <H3 class="no-margin margin-bottom-10">Translation </H3>
                ...
                <div class="row  table-function" id="third1">
                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="panel panel-info">
                      ...
                      <div class="panel-body">
                        <ul>
                          <li>Translations by subject expert native speakers only </li>
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="panel panel-pup">
                      ...
                      <div class="panel-body">
                        <ul>
                          <li>Translations by subject expert native speakers only </li>
                          <li>Connect with translator service</li>
                          <li>Quality guarantee. 100% on-time delivery</li>
                        </ul>
                      </div>
                      <div class="panel-footer">
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="panel panel-danger">
                      ...
                      <div class="panel-body">
                        <ul>
                          <li>Translations by subject expert native speakers only</li>
                          <li>Translations double-checked by academic authors</li>
                          <li>Connect with translator service</li>
                          <li>Quality guarantee with back translation</li>
                        </ul>
                      </div>
                      <div class="panel-footer">
