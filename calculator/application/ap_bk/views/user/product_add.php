 <!-- page content -->
            <div class="right_col" role="main">
                ...
                <div class="position-center">                    
                      ...
                      <form name="form" id="" class="form-horizontal" action="<?=base_url()?>index.php/admin/product_add/" method="post" enctype="multipart/form-data">
                        ...
                        <input class="form-control" type="hidden" value="<?=$this->session->userdata('mpstoreid');?>" name="store_id">
