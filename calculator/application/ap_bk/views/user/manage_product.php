 <!-- page content -->
          ...
          <a href="<?=base_url()?>index.php/admin/product_add"  class="btn btn-success pull-right" > Add New</a>
                            ...
                            <tbody>
                                ...
                                <?php $i = 1;foreach($products as $info)   { ?> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                        <div class="btn-group">
                                          <a class="btn btn-danger" href="<?=base_url()?>index.php/admin/deleteproduct/<?php print_r($info->product_id);?>"><i class="fa fa-times"></i></a>
                                        <?php if($info->status==0){?>
                                        <a class="btn btn-success"  href="<?=base_url()?>index.php/admin/verifyproduct/<?php print_r($info->product_id);?>">Activate</a>
                                        <?php }else{?>
                                        <a class="btn btn-warning" href="<?=base_url()?>index.php/admin/unverifyproduct/<?php print_r($info->product_id);?>">Deactivate</a>
                                        <?php }?>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 ...
 <div class="modal-header">
            ...
            <form name="form" id="" class="form" action="<?=base_url()?>index.php/admin/product_update/" method="post" enctype="multipart/form-data">
...
function product_view(id,store_id){
     ...
     $.ajax({
               url     : "<?=base_url()?>index.php/admin/product_detail/"+id+"/"+store_id,
               type    : "POST",
...
function product_edit(id){
    ...
    var couimg=0;
     ...
     $.ajax({
                             url     : "<?=base_url()?>index.php/admin/product_edit/"+id,
                             type    : "POST",
                 success : function( data )
                        { 
...
{
    $.ajax({
              url     : "<?=base_url()?>index.php/admin/img_delete/"+id+"/"+store_id+"/"+product_id+"/"+image_name,
              type    : "POST",
              success : function( data )
              {
                   if(data==1)
...
{
  $.ajax({
                             url     : "<?=base_url()?>index.php/admin/add_to_deals/"+id,
                             type    : "POST",
                 success : function( data )
                        { 
