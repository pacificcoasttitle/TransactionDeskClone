...
<!-- page content -->
  ...
  <tbody>
    <tr >
      ...
      <td>
        <?php $image = $this->admin_model->get_images($item['id']); $key = $image[0];?>
    ...
    <?php endif; ?>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                            <input type="text"  class="form-control" id="parent_ref_id" placeholder="" name="parent_ref_id" required value="" onblur="check_ref_id(this.value)">
                         ...
                         <div class="form-group">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                            <input type="email"  class="form-control" id="email" placeholder=""  onblur="check_email()" name="username" required value="">
                                        </div>
                                    </div>
