...
class Welcome extends CI_Controller
{
    ...
    public function calculate_title_rate($post)
    {
        ...
        //print_r("------ Title Rate -----<br>");
        //print_r("Purchase Rate ".$purchase_rate."<br>");
        //print_r("lender Rate ".$lender."<br>");
    ...
    public function calculate_escrow_fee_resale($post)
    {
        ...
        //print_r("<br>");
        //print_r("------ Escrow Rate resale -----<br>");
        //print_r("base Rate ".$rate->base_rate."<br>");
        //print_r("per 1k Rate ".$rate->rate_per_1k."<br>");
        //print_r("multifactor ".$rate->multi_factor."<br>");
    ...
    public function calculate_escrow_fee_refinance($post)
    {
        ...
        //print_r("<br>");
        //print_r("------ Escrow Rate re finance-----<br>");
        //print_r("escrow Rate ".$rate->escrow_rate."<br>");
        // print_r($rate);
    ...
    public function receipt()
    {
        ...
        redirect('welcome/view_quote/' . $quote_id, 'refresh');
    }
    ...
    public function view_quote($quote_id = '')
    {
        if ($quote_id) {
            ...
            $this->load->view('front/header', $data);
            $this->load->view('front/recipt', $data);
            $this->load->view('front/footer', $data);
        } elseif ($_POST['quote_id']) {
            redirect('welcome/view_quote/' . $_POST['quote_id'], 'refresh');
        } else {
            redirect('/', 'refresh');
        }
    ...
    public function login_user()
    {
        ...
        if (isset($_POST['email'])) {
            ...
            if ($user) {
                ...
                if ($user->is_active == '1') {
                    $this->session->set_userdata('mpuserid', $user->user_id_pk);
                    $this->session->set_userdata('mpusername', $user->first_name);
                    $this->session->set_userdata('mpuseremail', $user->email);
                    $this->session->set_userdata('mpusertype', $user->membership_id_fk);
                    $this->session->set_userdata('mpusermembership', $user->membership);
...
public function is_admin()
  ...
  {
      $this->load->view('front/header', $data);
      $this->load->view('front/admin_login', $data);
      $this->load->view('front/footer', $data);
  }
...
public function admin_dashboard()
  {
    ...
    $data['roles'] = $this->welcome_model->get_all_roles();
      $this->load->view('front/header', $data);
      $this->load->view('front/admin_dashboard', $data);
      $this->load->view('front/footer', $data);
  }
