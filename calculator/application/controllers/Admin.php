...
// Start session on top of codeignitor seems codeignitor 3.0 not working well on session libs
session_start();
...
class Admin extends CI_Controller
{
    ...
    public function title_rates()
    {
        ...
        $this->load->view('admin/title_rates', $data);
    ...
    public function import_title_rates()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/import_title_rates', $data);
        $this->load->view('admin/footer', $data);
    }
    ...
    public function refinance_rates()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/refinance_rates', $data);
        $this->load->view('admin/footer', $data);
    }
    ...
    public function add_refinance_rates()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/add_refinance_rates', $data);
        $this->load->view('admin/footer', $data);
    }
    ...
    public function resale_rates()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/resale_rates', $data);
        $this->load->view('admin/footer', $data);
    }
    ...
    public function add_resale_rates()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/add_resale_rates', $data);
        $this->load->view('admin/footer', $data);
    }
    ...
    public function add_fees()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/add_fees', $data);
        $this->load->view('admin/footer', $data);
    ...
    public function edit_resale_rates()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/edit_resale_rates', $data);
        $this->load->view('admin/footer', $data);
    }    
    ...
    public function edit_refinance_rates()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/edit_refinance_rates', $data);
        $this->load->view('admin/footer', $data);
    }
    ...
    public function edit_fees()
    {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/edit_fees', $data);
        $this->load->view('admin/footer', $data);
    }
    ...
    public function edit_title_rates()
    {
        ...
        {
            redirect('admin/title_rates');
        }
        $data['rate_info'] = $rate_info;

        $this->load->view('admin/header', $data);
        $this->load->view('admin/edit_title_rates', $data);
        $this->load->view('admin/footer', $data);
    }
