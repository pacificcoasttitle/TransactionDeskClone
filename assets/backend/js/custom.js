...
$(document).ready(function () {
    ...
    if ($('#tbl-customers-listing').length || $('#tbl-sp-escrow-listing').length || $('#tbl-agents-listing').length || $('#tbl-sp-agents-listing').length || $('#tbl-lenders-listing').length || $('#tbl-sp-lenders-listing').length || $('#tbl-sales-rep-listing').length || $('#tbl-sp-sales-rep-listing').length || $('#tbl-title-officer-listing').length || $('#tbl-sp-title-officer-listing').length || $('#tbl-credentials-customers-listing').length || $('#tbl-cpl-documents-listing').length || $('#tbl-new-users-listing').length || $('#tbl-master-users-listing').length || $('#tbl-companies-listing').length || $('#tbl-cpl-proposed-users-listing').length || $('#tbl-escrow-instruction-listing').length || $('#tbl-lp-xml-listing').length) {
        jQuery.fn.DataTable.Api.register('buttons.exportData()', function (options) {
            ...
            if (this.context.length) {
                if (this.context[0].sTableId == 'tbl-customers-listing') {
                ...
                else if (this.context[0].sTableId == 'tbl-policy-documents-listing') {
                    var jsonResult = $.ajax({
                        type: "POST",
                        url: base_url + "admin/order/home/get_policy_document_list",
                        data: {
                            keyword: $('#tbl-policy-documents-listing_filter input').val(),
                        },
                        success: function (result) {
                        },
                        async: false
                    ...
                    var data = jsonResult.responseText;
                    var res = jQuery.parseJSON(data);
                    return { body: res.data, header: $("#tbl-policy-documents-listing thead tr th:not(:last-child)").map(function () { return this.innerHTML; }).get() };
                }
    ...
    if ($('#tbl-policy-documents-listing').length) {
        $('#tbl-policy-documents-listing').DataTable({
            "paging": true,
            "lengthMenu": [10, 20, 50, 100, 200, 500, 1000],
            "columnDefs": [
                { "searchable": false, "targets": [0, 1] }
            ...
            "ajax": {
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    $("#tbl-policy-documents-listing tbody").append('<tr><td colspan="4" class="text-center">No records found</td></tr>');
                    $("#tbl-policy-documents-listing_processing").css("display", "none");
    ...
    if ($('#tbl-cron-logs').length) {
        cron_logs = $('#tbl-cron-logs').DataTable({
            "paging": true,
            "lengthMenu": [10, 20, 50, 100, 200, 500, 1000],
            "columnDefs": [
                { "searchable": false, "targets": [0, 1] }
            ...
            "serverSide": true,
            "ajax": {
                url: base_url + "admin/order/home/get_cron_logs",
                type: "post",
                beforeSend: function () {
                    $("#page-preloader").show();
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    $("#tbl-cron-logs-listing tbody").append('<tr><td colspan="4" class="text-center">No records found</td></tr>');
                    $("#tbl-cron-logs-listing_processing").css("display", "none");
    ...
    if ($('#tbl-recording-email-logs').length) {
        recording_email_logs = $('#tbl-recording-email-logs').DataTable({
            "paging": true,
            "lengthMenu": [10, 20, 50, 100, 200, 500, 1000],
            "columnDefs": [
                { "searchable": false, "targets": [0, 1] }
            ...
            "serverSide": true,
            "ajax": {
                url: base_url + "admin/order/home/get_recording_email_logs",
                type: "post",
                beforeSend: function () {
                    $("#page-preloader").show();
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    $("#tbl-recording-email-logs-listing tbody").append('<tr><td colspan="4" class="text-center">No records found</td></tr>');
                    $("#tbl-recording-email-logs-listing_processing").css("display", "none");
    ...
    if ($('#tbl-sms-logs').length) {
        sms_logs = $('#tbl-sms-logs').DataTable({
            "paging": true,
            "lengthMenu": [10, 20, 50, 100, 200, 500, 1000],
            "columnDefs": [
                { "searchable": false, "targets": [0, 1] }
            ...
            "serverSide": true,
            "ajax": {
                url: base_url + "admin/order/home/get_sms_logs",
                type: "post",
                beforeSend: function () {
                    $("#page-preloader").show();
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    $("#tbl-sms-logs-listing tbody").append('<tr><td colspan="4" class="text-center">No records found</td></tr>');
                    $("#tbl-sms-logs-listing_processing").css("display", "none");
    ...
    if ($('#tbl-title-production-listing').length) {
        title_production_list = $('#tbl-title-production-listing').DataTable({
            /*"pageLength": 2,*/
            "paging": true,
            "lengthMenu": [10, 20, 50, 100, 200, 500, 1000],
            "columnDefs": [
            ...
            "serverSide": true,
            "ajax": {
                url: base_url + "admin/order/home/get_title_production_list", // json datasource
                type: "post",
                beforeSend: function () {
                    $("#page-preloader").show();
                },
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    $("#tbl-title-production-listing-listing tbody").append('<tr><td colspan="12" class="text-center">No records found</td></tr>');
                    $("#tbl-title-production-listing-listing_processing").css("display", "none");
    ...
    if ($('#tbl-sp-title-production-listing').length) {
        sp_title_production_list = $('#tbl-sp-title-production-listing').DataTable({
            /*"pageLength": 2,*/
            "paging": true,
            "lengthMenu": [10, 20, 50, 100, 200, 500, 1000],
            "columnDefs": [
            ...
            "serverSide": true,
            "ajax": {
                url: base_url + "admin/order/home/get_sp_title_production_list", // json datasource
                type: "post",
                beforeSend: function () {
                    $("#page-preloader").show();
                },
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    $("#tbl-sp-title-production-listing-listing tbody").append('<tr><td colspan="12" class="text-center">No records found</td></tr>');
                    $("#tbl-sp-title-production-listing-listing_processing").css("display", "none");
    ...
    if ($('#tbl-sp-escrow-production-listing').length) {
        sp_escrow_production_list = $('#tbl-sp-escrow-production-listing').DataTable({
            /*"pageLength": 2,*/
            "paging": true,
            "lengthMenu": [10, 20, 50, 100, 200, 500, 1000],
            "columnDefs": [
            ...
            "serverSide": true,
            "ajax": {
                url: base_url + "admin/order/home/get_sp_escrow_production_list", // json datasource
                type: "post",
                beforeSend: function () {
                    $("#page-preloader").show();
                },
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    $("#tbl-sp-escrow-production-listing-listing tbody").append('<tr><td colspan="12" class="text-center">No records found</td></tr>');
                    $("#tbl-sp-escrow-production-listing-listing_processing").css("display", "none");
...
function deleteTitleProductionUser(id) {
    ...
    if (ready) {
        $.ajax({
            url: base_url + "order/admin/delete-title-production",
            method: "POST",
            data: {
                id: id,
                status: 0
            ...
            success: function (data) {
                var result = jQuery.parseJSON(data);
                if (result.status == 'success') {
                    $('#title_production_success_msg').html(result.message).show();
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#title_production_success_msg").offset().top
                    }, 1000);
                    title_production_list.ajax.reload(null, false);
                    setTimeout(function () {
                        $('#title_production_success_msg').html('').hide();
                    }, 4000);
                } else {
                    $('#title_production_error_msg').html(result.message).show();
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#title_production_error_msg").offset().top
                    }, 1000);

                    setTimeout(function () {
                        $('#title_production_error_msg').html('').hide();
                    }, 4000);
                }
            },
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                $('#title_production_error_msg').html('Something went wrong. Please try it again.').show();
                $([document.documentElement, document.body]).animate({
                    scrollTop: $("#title_production_success_msg").offset().top
                }, 1000);
...
function deleteSpTitleProductionUser(id) {
    if (id == '') {
        alert('Payoff User ID is required.');
        return false;
    }
    ...
    if (ready) {
        $.ajax({
            url: base_url + "order/admin/delete-softpro-title-production",
            method: "POST",
            data: {
                id: id,
                status: 0
            ...
            success: function (data) {
                var result = jQuery.parseJSON(data);
                if (result.status == 'success') {
                    $('#sp_title_production_success_msg').html(result.message).show();
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#sp_title_production_success_msg").offset().top
                    }, 1000);
                    sp_title_production_list.ajax.reload(null, false);
                    setTimeout(function () {
                        $('#sp_title_production_success_msg').html('').hide();
                    }, 4000);
                } else {
                    $('#sp_title_production_error_msg').html(result.message).show();
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#sp_title_production_error_msg").offset().top
                    }, 1000);

                    setTimeout(function () {
                        $('#sp_title_production_error_msg').html('').hide();
                    }, 4000);
                }
            },
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                $('#sp_title_production_error_msg').html('Something went wrong. Please try it again.').show();
                $([document.documentElement, document.body]).animate({
                    scrollTop: $("#sp_title_production_success_msg").offset().top
                }, 1000);
...
function deleteSpEscrowProductionUser(id) {
    if (id == '') {
        alert('Escrow Production ID is required.');
        return false;
    }
    ...
    if (ready) {
        $.ajax({
            url: base_url + "order/admin/delete-softpro-escrow-production",
            method: "POST",
            data: {
                id: id,
                status: 0
            ...
            success: function (data) {
                var result = jQuery.parseJSON(data);
                if (result.status == 'success') {
                    $('#sp_escrow_production_success_msg').html(result.message).show();
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#sp_escrow_production_success_msg").offset().top
                    }, 1000);
                    sp_escrow_production_list.ajax.reload(null, false);
                    setTimeout(function () {
                        $('#sp_escrow_production_success_msg').html('').hide();
                    }, 4000);
                } else {
                    $('#sp_escrow_production_error_msg').html(result.message).show();
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#sp_escrow_production_error_msg").offset().top
                    }, 1000);

                    setTimeout(function () {
                        $('#sp_escrow_production_error_msg').html('').hide();
                    }, 4000);
                }
            },
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                $('#sp_escrow_production_error_msg').html('Something went wrong. Please try it again.').show();
                $([document.documentElement, document.body]).animate({
                    scrollTop: $("#sp_escrow_production_success_msg").offset().top
                }, 1000);
...
function fetchRevenueReport() {
    ...
    $.ajax({
        url: base_url + "fetch-revenue-report",
        method: "POST",
        success: function (data) {
            var result = jQuery.parseJSON(data);
            console.log(result);
...
function updateMailNotificationReps() {
    $('input[type="checkbox"]').on('change', function () {
        ...
        $.ajax({
            url: base_url + "update-reps-mail-flag",
            method: "POST",
            data: {
                id: id,
                flag: flag
            ...
            success: function (data) {
                ...
                if (result.status == 'success') {
                    $('body').animate({ opacity: 1.0 }, "slow");
                    $('#sales_rep_success_msg').html(result.msg).show();
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#sales_rep_success_msg").offset().top
                    }, 1000);
                    sales_rep_list.ajax.reload(null, false);
...
function updateMailNotificationUsers(flagType = 'recording') {
    $('input[type="checkbox"]').on('change', function () {
        ...
        $.ajax({
            url: base_url + "update-users-mail-flag",
            method: "POST",
            data: {
                id: id,
                flag: flag,
...
function syncSoftProOrdersStatus() {
    $("#page-preloader").show();

    $.ajax({
        url: base_url + "update-softpro-order-status",
        method: "POST",
        success: function (data) {
            var result = jQuery.parseJSON(data);
            console.log(result);
