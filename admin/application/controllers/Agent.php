...
class Agent extends CI_Controller {
    ...
    public function get_agent_list()
    {
        ...
        if(isset($agent_lists['data']) && !empty($agent_lists['data']))
        {
            foreach ($agent_lists['data'] as $key => $value) 
            {
                ...
                if(isset($_POST['draw']) && !empty($_POST['draw']))
                {
                    $editOrderUrl = base_url().'?edit-agent/'.$value['id'];
    ...
    public function edit()
    {
        ...
        if(isset($id) && !empty($id))
        {
            ...
            {
                // Validations
                $this->form_validation->set_rules('first_name', 'First Name', 'required',array('required'=> 'Enter your first name'));
                $this->form_validation->set_rules('last_name', 'Last Name', 'required',array('required'=> 'Enter your last name'));
